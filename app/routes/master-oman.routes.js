...
module.exports = function (app) {
  ...
  app.patch("/api/edit-oman-governorate", [authJwt.verifyToken], controller.editOmanGovernorate);
  ...
  app.patch("/api/edit-oman-wilayat", [authJwt.verifyToken], controller.editOmanWilayat);
  // Oman Cities
  ...
  app.patch("/api/edit-oman-city", [authJwt.verifyToken], controller.editOmanCity);
  // Oman Areas
  ...
  app.patch("/api/edit-oman-area", [authJwt.verifyToken], controller.editOmanArea);
};
